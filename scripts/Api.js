...
*/
  ...
  * Здравствуйте.  
  ...
  Не работает, да даже не отображается удаление карточек, надо исправить ---------------------- Работает, проверил много раз. Удалять можно только свои карточки. Добавьте карточку и проверьте.
